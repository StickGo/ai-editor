             ...
             <h2 className="text-4xl md:text-6xl font-bold font-heading mb-6 text-white">Let's Create Together</h2>
               <div className="flex flex-col items-center gap-10 mt-10">
                ...
                <a 
                  ...
                  className="inline-flex items-center gap-3 px-10 py-5 bg-white text-black font-bold tracking-widest uppercase hover:bg-gray-200 transition-all hover:scale-105 active:scale-95 shadow-xl"
                >
                ...
                {/* Domicile Badge - "Keren" version */}
                <motion.div 
                  initial={{ opacity: 0, scale: 0.9 }}
                  whileInView={{ opacity: 1, scale: 1 }}
                  whileHover={{ y: -5 }}
                  className="flex items-center gap-3 px-6 py-2 bg-white/5 backdrop-blur-md border border-white/10 rounded-full group cursor-default mb-10"
                >
                  <div className="relative flex items-center justify-center">
                    <MapPin className="w-4 h-4 text-[var(--color-medium)] relative z-10" />
                    <span className="absolute inset-0 bg-[var(--color-medium)]/40 rounded-full blur-[8px] animate-pulse" />
                  </div>
                  <div className="flex flex-col items-start leading-none">
                    <span className="text-[10px] uppercase tracking-[0.2em] text-white/30 font-mono mb-1">Based in</span>
                    <span className="text-sm font-bold text-white tracking-widest uppercase">Bandung, Indonesia</span>
                  </div>
                  
                  {/* Status Indicator */}
                  <div className="ml-2 flex items-center gap-2 px-2 py-1 bg-[var(--color-medium)]/10 rounded-full border border-[var(--color-medium)]/20">
                    <span className="relative flex h-2 w-2">
                      <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[var(--color-medium)] opacity-75"></span>
                      <span className="relative inline-flex rounded-full h-2 w-2 bg-[var(--color-medium)]"></span>
                    </span>
                    <span className="text-[10px] font-mono text-[var(--color-medium)] uppercase tracking-tighter">Available</span>
                  </div>
                </motion.div>
              </div>
           </motion.div>
